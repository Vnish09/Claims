...
public class AuthorizationApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		AuthenticationRequest user1 = new AuthenticationRequest("aniii","iii12");
		AuthenticationRequest user2 = new AuthenticationRequest("anish","12ani");
		//AuthenticationRequest user3 = new AuthenticationRequest("hello","root");
